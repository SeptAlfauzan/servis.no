...
export default function SuccessScreen({ navigation, route }) {
    return (
        <View style={tw`flex h-full w-full justify-center items-center bg-green-400`}>
            ...
            <Text style={tw`text-white text-xl text-center w-3/4`}>{route.params.text}</Text>
            <TouchableOpacity style={tw`bg-green-500 px-8 py-2 mt-10 rounded-full`} onPress={() => navigation.navigate(route.params.view)}>
