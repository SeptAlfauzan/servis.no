        ...
        >
            ...
            {data && Array.from(data).map(d => (
                <>
                    <View
                        key={d.id}
                        style={tw`w-full border border-slate-300 rounded-lg px-5 py-3 flex-row justify-between mb-2`}
                    >
                        <View>
                            ...
                            <Text style={tw`text-red-600 font-bold mt-3`}>Order belum dibayar</Text>
                        </View>
                        <View
